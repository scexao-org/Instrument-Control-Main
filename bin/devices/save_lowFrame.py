...
#wder = "/media/data/20141113/LLOWFS/llowfs_images/lowFrames_"
wder="/home/scexao/Documents/Garima/November_test/Photon_noise/lowfs_"
...
camid = 2 # camera identifier (1:LLOWFS frame when llowfs llop is off)
...
buffer_is_full=[0,0]
image_cube=[np.empty((NB_frames, ysize, xsize), dtype='uint16') , np.empty((NB_frames, ysize, xsize), dtype='uint32') ]
time_text=["",""]
