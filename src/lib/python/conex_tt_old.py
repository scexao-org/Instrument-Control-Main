...
class Conex_tt(object):
    def __init__(self, port="COM4", baudrate=912600, bytesize=serial.EIGHTBITS,
    ...
    def _init(self):
        try:
            ...
            print("Could not connect to Conex Mount")
            raise

        #getLogger('conex').debug("Connected to Conex Mount")
        print("Connected to Conex Mount")
        self._started = 2
...
if __name__=='__main__':
    ...
    conex_manager = ConexManager(port='COM4')
