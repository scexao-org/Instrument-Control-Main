...
gen2.svconfig = {
    ...
    'description': DESCR.names,
    'cmddir': '../remoteObjects',
    'start': 'remoteObjectNameSvc.py --monport=7077 --monitor=g2stat:7080 --monauth=monitor:monitor --loglevel=debug --log=%s' % (
    '/tmp/ro_names.log'),
    'flags': ('each'),
    },
...
images coming from the guider cameras to both SOSS and Gen2.""",
    ...
    'cmddir': '/usr/bin',
    'start': 'sudo -u postgres /usr/lib/postgresql/8.3/bin/postmaster -p 5436 -D %s/star_catalog/db' % (dbdir()),
    'stop': 'sudo -u postgres /usr/lib/postgresql/8.3/bin/pg_ctl stop -w -D %s/star_catalog/db' % (dbdir()),
    ...
    'rundir': '%s/star_catalog' % (dbdir()),
    'cmddir': '/usr/bin',
    'start': 'sudo -u postgres /usr/lib/postgresql/8.3/bin/postmaster -p 5433 -D %s/star_catalog/db1' % (dbdir()),
    'stop': 'sudo -u postgres /usr/lib/postgresql/8.3/bin/pg_ctl stop -w -D %s/star_catalog/db1' % (dbdir()),
    ...
    'rundir': '%s/star_catalog' % (dbdir()),
    'cmddir': '/usr/bin',
    'start': 'sudo -u postgres /usr/lib/postgresql/8.3/bin/postmaster -p 5434 -D %s/star_catalog/db2' % (dbdir()),
    'stop': 'sudo -u postgres /usr/lib/postgresql/8.3/bin/pg_ctl stop -w -D %s/star_catalog/db2' % (dbdir()),
    ...
    'rundir': '%s/star_catalog' % (dbdir()),
    'cmddir': '/usr/bin',
    'start': 'sudo -u postgres /usr/lib/postgresql/8.3/bin/postmaster -p 5435 -D %s/star_catalog/db3' % (dbdir()),
    'stop': 'sudo -u postgres /usr/lib/postgresql/8.3/bin/pg_ctl stop -w -D %s/star_catalog/db3' % (dbdir()),
...
#    'start': 'TaskManager.py --port=8170 --svcname="taskmgr0" --monitor=monitor --session=main --numthreads=120 --stderr --loglevel=info',
    ...
    'count': 1,
    'cmddir': '../tools',
    'start': 'send_log.py --loglevel=debug --log=%s' % (
        get_log('sendlog.log')),
    ...
    'count': 1,
    'cmddir': '../tools',
    'start': 'delete_log.py --age=2 --loglevel=debug --log=%s' % (
        get_log('deletelog.log')),
    ...
    "vncs-ll": {
        ...
        'count': 1,
        'start': 'mytightvncserver %s  -dpi 100 -depth 24 -geometry 1910x1165 -alwaysshared' % (screen(gen2.disp.ll)),
    ...
    "vncs-ul": {
        ...
        'hosts': prefer([left(gen2.frontends)], gen2.frontends),
        'count': 1,
        'start': 'mytightvncserver %s  -dpi 100 -depth 24 -geometry 1910x1165 -alwaysshared' % (screen(gen2.disp.ul)),
    ...
    "vncs-lm": {
        ...
        'count': 1,
        'start': 'mytightvncserver %s  -dpi 100 -depth 24 -geometry 1910x1165 -alwaysshared' % (screen(gen2.disp.lm)),
    ...
    "vncs-um": {
        ...
        'hosts': prefer([mid(gen2.frontends)], gen2.frontends),
        'count': 1,
        'start': 'mytightvncserver %s  -dpi 100 -depth 24 -geometry 1910x1165 -alwaysshared' % (screen(gen2.disp.um)),
    ...
    "vncs-lr": {
        ...
        'count': 1,
        'start': 'mytightvncserver %s  -dpi 100 -depth 24 -geometry 1910x1165 -alwaysshared' % (screen(gen2.disp.lr)),
    ...
    "vncs-ur": {
        ...
        'hosts': prefer([right(gen2.frontends)], gen2.frontends),
        'count': 1,
        'start': 'mytightvncserver %s  -dpi 100 -depth 24 -geometry 1910x1165 -alwaysshared' % (screen(gen2.disp.ur)),
...
#         },
    ...
    "integgui2": {
        ...
        'start': 'integgui2.py --taskmgr=taskmgr0 --session=main --display=%s --loglevel=debug --log=%s' % (
            screen(gen2.disp.lm), get_log('integgui2.log')),
    ...
    "fitsviewer": {
        ...
        'start': 'fitsviewer.py --nopg --svcname=fitsview1 --geometry=+816+28 --display=%s --port=9501 --loglevel=10 --log=%s' % (
            screen(gen2.disp.um), get_log('fitsviewer.log')),
        'flags': ('prefer'),
        },
    ...
    "fitsview": {
        ...
        'start': 'fitsview.py --svcname=fitsview --bufsize=40 --port=9502 --geometry=+866+545 --display=%s --loglevel=debug --log=%s' % (
            screen(gen2.disp.ul), get_log('fitsview.log')),
        'flags': ('prefer'),
        },
...
#         },
    ...
    "sktask_gtk": {
        ...
        'start': 'sktask_gtk.py --channels=taskmgr0,g2task --display=%s --loglevel=info --log=%s' % (
            screen(gen2.disp.ul), get_log('sktask_gtk.log')),
        'flags': ('prefer', 'nosvccheck'),
        },
